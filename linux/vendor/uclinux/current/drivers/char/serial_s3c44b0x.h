/*
 * drivers/char/serial_s3c44b0x.h
 * 
 * Serial port driver for the Samsung S3C44B0X builtin UART
 *
...
#ifndef _S3C44B0X_SERIAL_H
#define _S3C44B0X_SERIAL_H
