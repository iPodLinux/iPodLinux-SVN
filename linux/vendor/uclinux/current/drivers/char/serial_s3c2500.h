...
#ifndef _s3c2500_SERIAL_H
#define _s3c2500_SERIAL_H
...
struct s3c2500_serial {
	...
	int			type; 		/* UART type */
	int			use_ints;
	volatile struct s3c2500_usart_regs	*usart;
	int			cts_state;
