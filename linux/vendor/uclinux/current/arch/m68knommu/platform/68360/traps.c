...
#define NUM_IRQ_NODES 96
static irq_node_t nodes[NUM_IRQ_NODES];

/* 
 * The flash interrupt vector table is in crt0_rom.S. If you are running from
 * RAM, this may not suite your purposes :-).
 */
