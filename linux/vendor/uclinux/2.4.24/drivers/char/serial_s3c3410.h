/*
 * drivers/char/serial_s3c3410.h
 * 
 * Serial port driver for the Samsung S3C3410X builtin UART
 *
 * Copyright (c) 2003 sympat GmbH
 * 	by Thomas Eschenbacher <thomas.eschenbacher@sympat.de>
 *
 * Based on: drivers/cahr/serial_s3c4530.h
...
#ifndef _S3C3410_SERIAL_H
#define _S3C3410_SERIAL_H
