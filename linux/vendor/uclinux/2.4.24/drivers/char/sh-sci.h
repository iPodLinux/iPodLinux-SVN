...
static inline int sci_rxd_in(struct sci_port *port)
{
	switch (port->base) {
	case 0x00ffff78:
		return H8300_GPIO_GETDIR(H8300_GPIO_P3,H8300_GPIO_B2) == 1;
	case 0x00ffff80:
		return H8300_GPIO_GETDIR(H8300_GPIO_P3,H8300_GPIO_B3) == 1;
	case 0x00ffffc0:
		return H8300_GPIO_GETDIR(H8300_GPIO_P5,H8300_GPIO_B1) == 1;
	}
}
#elif defined(CONFIG_CPU_SUBTYPE_SH5_101) || defined(CONFIG_CPU_SUBTYPE_SH5_103)
static inline int sci_rxd_in(struct sci_port *port)
