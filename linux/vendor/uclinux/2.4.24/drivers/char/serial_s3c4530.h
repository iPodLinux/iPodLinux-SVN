/*
 * drivers/char/serial-s3c4530.h
 * 
 * Serial port driver for the Samsung S3C4530A builtin UARTs
 *
...
#ifndef _S3C4530_SERIAL_H
#define _S3C4530_SERIAL_H
...
struct s3c4530_serial {
	...
	int			type; 		/* UART type */
	int			use_ints;
	volatile struct s3c4530_usart_regs	*usart;
	int			cts_state;
