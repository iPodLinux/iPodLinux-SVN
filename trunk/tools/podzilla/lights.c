...
/* size selectors... */
static void lights_set_size_3( void ) { lights_sel = 3; }
static void lights_set_size_4( void ) { lights_sel = 4; }
static void lights_set_size_5( void ) { lights_sel = 5; }
static void lights_set_size_6( void ) { lights_sel = 6; }
static void lights_set_size_7( void ) { lights_sel = 7; }
static void lights_set_size_8( void ) { lights_sel = 8; }

/* size selection menu */
item_st lights_size_menu[] = {
	{ "3x3 Lights", lights_set_size_3, SUB_MENU_PREV|ACTION_MENU },
	{ "4x4 Lights", lights_set_size_4, SUB_MENU_PREV|ACTION_MENU },
	{ "5x5 Lights", lights_set_size_5, SUB_MENU_PREV|ACTION_MENU },
	{ "6x6 Lights", lights_set_size_6, SUB_MENU_PREV|ACTION_MENU },
	{ "7x7 Lights", lights_set_size_7, SUB_MENU_PREV|ACTION_MENU },
	{ "8x8 Lights", lights_set_size_8, SUB_MENU_PREV|ACTION_MENU },
	{ 0 }
};
...
item_st lights_menu[] = {
	{ "Play Merlin 3x3", lights_start_merlin, ACTION_MENU },
	{ "Play Original - With Wrap", lights_start_original, ACTION_MENU },
	{ "Play Lit Only - With Wrap", lights_start_lit_only, ACTION_MENU },
	{ "Play Original - No Wrap", lights_start_original_nw, ACTION_MENU },
	{ "Play Lit Only - No Wrap", lights_start_lit_only_nw, ACTION_MENU },
	{ "Select Game Size...", lights_size_menu, SUB_MENU_HEADER },
	{ 0 }
};
