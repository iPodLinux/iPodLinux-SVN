...
typedef int (*btree_cmp) (struct btree_head *a, struct btree_head *b);

void btree_init(struct btree_head *head); 

struct btree_head *btree_find(struct btree_head **root, 
		struct btree_head *search, btree_cmp cmp);
