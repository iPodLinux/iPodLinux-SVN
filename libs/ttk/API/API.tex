...
\item[{\tt grouping_name} and {\tt grouping_flags}] determine what group the menu item should
be associated with in the menu.  These will sort alphabetically, then the items within them will be sorted alphabetically.  If there is none specified, it will be in a grouping which
will be sorted after all other groupings.
\end{description}
